...
@hydra.main(version_base=None, config_path='configs', config_name='config_multilabel.yaml')
def train_pipeline(cfg):
    ...
    checkpoint_callback = ModelCheckpoint(
        ...
        mode="max",
        filename="vit_mlp-{epoch:02d}-{val_f1_macro}",
    )
    ...
    trainer = pl.Trainer(
        callbacks=[
            # EarlyStopping(monitor=cfg.optimized_metric, mode="max"), 
            checkpoint_callback,
